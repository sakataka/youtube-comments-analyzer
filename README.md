...
6. 人物候補と表記を確認し、必要に応じて採用・除外、表示名編集、表記追加、統合、集計からの除外を行う。
7. 「候補を確定して集計」を押す。
8. 言及ランキング、人物別詳細、代表コメント、section status を確認する。
9. コメント一覧で本文検索や人物フィルタを使い、根拠コメントを確認する。
10. 必要に応じてコメント単位で人物紐づけを追加または解除する。
